...
export const en: GalleryStrings = {
  ...
  foundations: {
    ...
    inks: "Inks",
    lines: "Lines",
    inkWords: ["Body text", "Muted text", "Subtle text"],
    accent: "Accent",
    ...
    typeNote:
      "Each row is set in its own role's tokens; the Chinese column shows where the Latin face hands over to the CJK one.",
    scene: {
      pageTier: "page",
