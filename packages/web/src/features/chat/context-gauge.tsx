    ...
    <>
      ...
      {active && (
        <span
          ...
          className="absolute -bottom-6 rounded bg-gray-900 px-1.5 py-0.5 font-mono text-xs whitespace-nowrap text-fg-on-emphasis dark:bg-gray-100 dark:text-gray-900"
        >
